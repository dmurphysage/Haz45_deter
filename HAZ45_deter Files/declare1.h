c     real*8 Haz(MAX_INTEN, MAX_PROB, MAX_FLT)
c     real*8 magbar1(MAX_INTEN, MAX_PROB, MAX_FLT)
c     real*8 tempHaz(MAXPARAM,MAX_WIDTH,MAX_INTEN, MAX_PROB, MAX_ATTEN,MAX_FTYPE)
...
c      real*8 m_bar(MAX_PROB,MAX_INTEN), d_bar(MAX_PROB,MAX_INTEN)
c      real*8 Xcost_bar(MAX_PROB,MAX_INTEN)
c      real*8 e_bar(MAX_PROB,MAX_INTEN)
      real epsilon1 
