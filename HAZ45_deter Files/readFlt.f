...
c                Set mean char mag 
                 refMag(iFlt,i,iWidth) = refMag1(iWidth,iRefMag)
...
c                  check if this exceeds the limit magnitude                   
                   if ( rP3(iRecur) .ne. 0. ) then
                     if (maxMag(iFlt,i,iWidth) .gt. rP3(iRecur) ) maxMag(iFlt,i,iWidth)=rP3(iRecur)
                   endif
...
c                    check if this exceeds the limit magnitude                   
                     if ( maxMag(iFlt,i,iWidth) .gt. rP6(iRecur) ) then
                       maxMag(iFlt,i,iWidth)=rP6(iRecur)
                     endif
                   endif
                 endif
